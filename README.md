...
* Class modifications during run-time. They can't modify the classes. With this *Classful JS* you can also dynamically extend it inheriting from another class, and change the constructor on the fly.
* Partial inheritance. Most libraries only can call the super constructor, but what happens if you are overriding an inherited property? You probably will call the super property. With *Classful JS* you can achieve this and more.
